...
class TestKernels:
    def setup_method(self):
        ...
        self.kernel_ranges = {
            ...
            "wendland_c0": np.inf,  # valid everywhere, but zero for dr > 1
            "wendland_c2": np.inf,
            "wendland_c4": np.inf,
            "wendland_c6": np.inf,
            "wu_c2": np.inf,
